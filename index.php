...
<html lang="en">
  ...
  <body>
    ...
    <div class="calculator">
      ...
      <!-- readonly prevents user typing directly -->
      ...
      <div class="buttons">
        ...
        <!-- Append cosine function -->
        <button onclick="append('Math.tan(')">tan</button>
        <!-- Append tangent function -->
